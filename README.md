...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/late-resonance-2649)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/late-resonance-2649
```

A live public deployment of this template is available at [https://late-resonance-2649.templates.workers.dev](https://late-resonance-2649.templates.workers.dev)
